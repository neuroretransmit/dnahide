 ...
 */
#define DECL_PBKDF2(_name, _blocksz, _hashsz, _ctx, _init, _update, _xform, _final, _xcpy, _xtract, _xxor)   \
    typedef struct {                                                                                         \
        _ctx inner;                                                                                          \
        _ctx outer;                                                                                          \
    } HMAC_CTX(_name);                                                                                       \
    ...
    static inline void PBKDF2_F(_name)(const HMAC_CTX(_name) * startctx, uint32_t counter,                   \
                                       const uint8_t* salt, size_t nsalt, uint32_t iterations, uint8_t* out) \
    {                                                                                                        \
        uint8_t countbuf[4];                                                                                 \
        ...
        _xtract(&result, out);                                                                               \
                                                                                                             ...
                                                                                                             \
    static inline void PBKDF2(_name)(const uint8_t* pw, size_t npw, const uint8_t* salt, size_t nsalt,       \
...
DECL_PBKDF2(sha1, SHA_CBLOCK, SHA_DIGEST_LENGTH, SHA_CTX, SHA1_Init, SHA1_Update, SHA1_Transform, SHA1_Final,
            sha1_cpy, sha1_extract, sha1_xor)
